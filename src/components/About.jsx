        ...
        return (
          <div key={index}>
            <div className="flex items-center relative justify-between">
              ...
              <span className="bg-terciary absolute lg:w-[15px] lg:h-[15px] w-[8px] h-[8px] rounded-full lg:top-[55px] top-4 lg:left-[39%] left-[52%]"></span>
            ...
            <div className="flex flex-col lg:flex-row gap-y-4">
              ...
              <div className="flex-auto lg:w-1/2 my-4 px-12">
                <div className="w-full h-full">
                  {education.map((edu, index) => {
                    const { title, name, year } = edu;
                    return (
                      <div key={index} className="flex flex-col h-auto justify-start px-0 gap-y-4">
